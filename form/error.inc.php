...
<!-- JavaScript Before php so it shows up -->
...
<main id="main">
    ...
    <div class="about-intro-container">
      ...
      <div class="about-intro">
        ...
        <h5 class="faded-teal">Missing fields</h5>
        <p class="white">Sorry, you have not completed all of the required fields.</p>
        <br>
        <p>Please hit <a href="#" onClick="history.go(-1)"><span class="white">back</span></a> and complete the following required fields.</p>
        <br>
        <ul>
        <?php
        ...
        <p>
          <a href="#" onClick="history.go(-1)">Back to form</a>
        </p>
