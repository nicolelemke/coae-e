...
<main id="main">
    ...
    <div class="about-intro-container">
      <p class="page-breadcrumb">/ CONTACT / THANK YOU</p>
      <div class="about-intro">
        <img src="../images/coae-abrv-white.png" alt="COA white short logo" title="COA white short logo" width="200"/>
        <h5 class="faded-teal">THANK YOU!</h5>
        <p class="white">Thanks for your message. We will be in touch with you shortly</p>
      </div>
    </div>
